...
const ContactSection = () => (
  <section id="contact" className="relative w-full pt-32 pb-20 bg-[#002060] dark:bg-[#18181b] text-white z-10 overflow-hidden">
    <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="tel:18002333555" className="text-orange-400 underline font-semibold">1800-2333-555</a>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-2xl">📞</span>
          <span className="font-semibold">Commercial LPG Helpline No.:</span>
          <a href="tel:18605991111" className="text-orange-400 underline font-semibold">1860-5991-111</a>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-2xl">🚨</span>
          <span className="font-semibold">LPG Emergency Helpline:</span>
          <a href="tel:1906" className="text-orange-400 underline font-semibold">1906</a>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-2xl">✉️</span>
          <span className="font-semibold">Email:</span>
          <a href="mailto:iocl.cocc@indianoil.in" className="text-orange-400 underline font-semibold">iocl.cocc@indianoil.in</a>
        </div>
      </div>
      {/* Contact Form */}
      <form className="bg-white dark:bg-[#23272f] rounded-lg p-8 text-[#002060] dark:text-white shadow-lg space-y-4 border-0 dark:border dark:border-orange-400 relative z-10" aria-label="Contact form">
